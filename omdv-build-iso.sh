...
getPkgList() {
	...
	if [ ! -d "$WORKDIR/iso-pkg-lists-${TREE,,}" ]; then
		...
		# https://github.com/OpenMandrivaAssociation/omdv-build-iso/archive/${GIT_BRNCH}.tar.gz
		wget -qO- https://github.com/vuatech/omdv-build-iso/archive/refs/heads/Patch-for-testing-repo.zip  | tar -xz --strip-components=1
