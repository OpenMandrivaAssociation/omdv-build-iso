...
EOF
	...
	SERVICES_ENABLE=(getty@tty1.service sshd.socket irqbalance systemd-timesyncd vboxadd dnf-makecache.timer dnf-automatic.timer dnf-automatic-notifyonly.timer dnf-automatic-download.timer dnf-automatic-install.timer)
